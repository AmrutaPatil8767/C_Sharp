...
namespace SGM_Student_Mgt_Syst_2022
{
    public partial class Frm_Add_New_Student : Form
    {
          ...
          int Auto_Incr()
        {
            ...
            Cmd.Connection = Con;
            Cmd.CommandText = "Select Count (*) From SGM_Mgt_Syst_Details";

            Cnt = Convert.ToInt32(Cmd.ExecuteScalar());
            if (Cnt > 0)
            {
                Cmd.CommandText = "Select Max(RNo)From SGM_Mgt_Syst_Details";
        ...
        {
         {
            ...
            if (txt_Roll_No.Text != "" && txt_Name.Text != "" && txt_Mob_No.Text != "" && txt_Mob_No.TextLength == 10 && cmb_Course.Text != "")
            {
                ...
                Cmd.CommandText = "Insert Into SGM_Mgt_Syst_Details(RNo,Nm,DOB,MNo,Course) values (@RNo,@Nm,@DOB,@MNo,@Course)";
